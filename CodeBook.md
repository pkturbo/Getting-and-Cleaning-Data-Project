...
The following 79 columns contain the averages for the variable listed that contain the measurements on the mean or standard deviation (i.e features that contain the strings "mean" or "std"), averaged for each Subject and Activity
